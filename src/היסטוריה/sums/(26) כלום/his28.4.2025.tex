...
\author{שחר פרץ}
\title{\textit{היסטוריה 26}}
\begin{document}
	\maketitle
	שיעור הבא ביום שני – לא יתקיים כי שרית לא תגיע. השבוע יום הזיכרון. שבוע שעבר יום השואה. שרית נוהגת בשבוע של יום הזיכרון לעשות שיעור על יו םהזכרון. 
