...
\begin{document}
	...
	החומר שיוצג בשיעור הזה – שייך לפרק הבא ולא יהיה חלק מהמבחן. 
	
	\section{\en{For the test}}
	...
	\subsection{חזרה על חומר}
	יש הסבר מיוחד להשפעות החילוניות בעבור היהדות. פרט להסבר הרגיל בעבור כל התנועות הלאומיות, בציונות היה חשש שהיהדות תעלם כתוצאה מתהליך החילון, ובכך הרעיון הלאומי החליף את הדת (למטרת מניעת התבוללות). היו גם דברים הקשורים לבוא המשיח והקץ. 
	
	\section{\en{Nazism}}
	<תמונה של היטלר> בימים הבאים יש להביא את הספר של טוטאליטריות ושואה. 
	
	\subsection{על המשטר הטוטאליטרי ואופן השגת מטרותיו}
