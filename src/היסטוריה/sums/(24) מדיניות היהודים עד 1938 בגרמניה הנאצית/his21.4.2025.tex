...
\begin{document}
	\maketitle
	מבחן – ב־19 למאי. החומר עד גרמניה ב־1939. "אני ילמד עוד נושאים עד סוף השנה", כולם לבגרות, אך הצוות החליט שהמבחן יהיה עד גרמניה הנאצית. בתחילת שנה הבאה יהיה מבחן עד החומר הנותר. פרטים נוספים בשבוע הבא. המבחן יכלול פרק לגרמנהי הנאצית ופרק ללאומיות. 
	
	\section{חזרה לגרמניה $\sim$ סיכום נושא $\sim$ מדיניות יהודים עד 1939 $\sim$ מבוא}
	...
	\section{פירוט האירועים נגד היהודים}
	\subsection{יום החרם – 1 באפריל 1933}
