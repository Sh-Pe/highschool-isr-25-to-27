...
\author{שחר פרץ}
\title{\textit{היסטוריה 23}}
\begin{document}
	\maketitle
	
	\section{"חישוב מסלול מחדש"}
	\subsection{טרור הוא חלק ממאפייני המשטר הטוטאליטרי}
