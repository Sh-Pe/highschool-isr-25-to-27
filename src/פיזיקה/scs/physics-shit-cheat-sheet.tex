...
\begin{document}
	...
	\begin{multicols}{3}
		...
		\[ U_E = k \sum_{A, B} \frac{q_Aq_B}{\dist(A, B)} \ \cl{\text{singular }\frac{kqQ}{r}} \]
		...
		\[ E = -\frac{\md v}{\dx} \quad V = -\int E\dx \seq \frac{E}{d} \]
		...
		\[ V = E \cdot d \]
		\[ U_{\text{capacitor}} = \frac{1}{2}QV = \frac{1}{2}CV^2 = \frac{Q^2}{2C} \]
		\[ U_{\text{battery}} = QV = CV^2 = \frac{Q^2}{C} \]
		\[ C = \frac{\eg_0 \eg_r A}{d} \]
		\[ E = \frac{V}{d} = \frac{\sg}{\eg_0 \eg_r} = \frac{Q}{A \eg_0 \eg_r} \]
		But for circular capacitor: 
		\[ C = \frac{R_{\text{inner}}R_{\text{outer}}}{k(R_\text{outer} - R_\text{inner})} \]
		(needs proving) when a capacitor is unconnected to a voltage source, inserting a dielectric will require: 
		\[ W_{\text{external}} = \frac{Q^{2}}{2C}\cl{\frac{1}{\eg_r} - 1}< 0 \]
		When connected to a battery: 
		\[ W_{\text{external}} = -\frac{1}{2}V^{2}C\cl{\eg_r - 1} < 0 \]
