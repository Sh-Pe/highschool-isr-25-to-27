...
\begin{document}
	...
	\hfil\textit{\small Made as a part of the English Research Project for Module E and COBE}
...
%	\addcontentsline{toc}{section}{Bibliography}
	...
	\textbf{Some Notes: }
	\begin{itemize}
		\item Voicing in the Podcast is done by me. I changed the semitone pitches in DaVinci Resolve in order to make a distinction between the different characters in the fake interviews. 
		\item The second and the third research questions mostly deduce things from the information in the first one, hence don't have that many sources. 
	\end{itemize}
	...
	This whole research project started when I asked my history teacher, Sarit, why Israel chose to ignore International and even Jewish history, if it does not fit the government's intentions (more information in section (3)). According to her, each nation (In Israel's case, Zionism) tries to keep its intentions when teaching history, and that it is done internationally -- not just in Israel. 
	...
	\begin{itemize}
		\item The official syllabus of the state is usually written in the native language of the place. In cases like the USA and Israel, it was not a problem, but for France and Germany (a subsection that, in the end, I dismissed), I've had to rely on a translation. I mostly used Google Translate. 
	...
	\subsection{France}
	Perhaps the best example of a curriculum that tries to convey a feeling of being wide and comprehensive, but when you dig in, you find a clear bias towards a certain attitude. First of all, we need to understand two things about the education system in France as a whole: 
	\begin{itemize}
	...
	\begin{multicols}{2}
		...
		\end{enumerate}
	\end{multicols}
	We would want to emphasize how the French History Program views the French Revolution\mc{franceEDU}: 
	\begin{itemize}
	...
	We would want to remark the fact that the Program for General school covers events that happened in the world after 1945, such as the South African Genocide and the Cold War. With that said, a substantial focus of this chapter is on changes in France itself. 
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item China is communist (this is just formally true) -- ``[...] that resulted in [...] communist-run People’s Republic of China'' (page 25). 
		\end{itemize}
	\end{itemize}
	...
	\gothstart In this section, I'll attempt to answer the second research question -- ``What does it [the history curriculum] teach about the state's intentions?'', using the information we collected in the first section. Considering all of the information has already been gathered, these last two sections will not cite many sources. 
	...
	I do not think this project helped my English improve. The most problematic for me is speaking fluently, while the written part does not involve any speaking at all, and the Podcast is pre-written. 
	
	If I were to do the project today, I do not think I would have changed anything. It did not make me a better independent learner, nor more confident in myself, since I am used to work on my own in University. As for AI engines, I relied heavily on Google Translate to translate articles in French and German, and I used Adobe AI tools to denoise parts of the podcast. 
